<script>
    ...
    function getBadgeColor(type) {
        return type === 'Pengiriman' ? 'badge-primary' : 'badge-accent';
    }
</script>
    ...
    <div class="bg-base-100 shadow-xl rounded-box p-6">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-6">
            ...
            <div class="flex gap-2 flex-wrap">
                <button class="btn btn-sm {$filterType === 'Semua Notifikasi' ? 'btn-primary' : 'btn-outline'}" 
                        on:click={() => setFilter('Semua Notifikasi')}>
                    Semua Notifikasi
                </button>
                <button class="btn btn-sm {$filterType === 'Pengiriman' ? 'btn-primary' : 'btn-outline'}" 
                ...
                <button class="btn btn-sm {$filterType === 'Pembelian' ? 'btn-primary' : 'btn-outline'}" 
        ...
        <!-- <div class="mb-4">
            <div class="stats bg-base-200 shadow">
                <div class="stat">
                    ...
                    <div class="stat-value text-primary">{filteredNotifications.length}</div>
